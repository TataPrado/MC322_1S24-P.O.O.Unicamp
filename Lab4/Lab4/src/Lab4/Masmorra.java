...
public class Masmorra {
    ...
    public Masmorra() {
        this.tesouros = new BauDeTesouros();
    }
    ...
    public Item abrirPortaItem(Jogador jogador) {
        ...
        Lab4.Item itemEscolhido = tesouros.acessarItem(itensDisponiveis.get(escolha - 1).getNomeItem());
